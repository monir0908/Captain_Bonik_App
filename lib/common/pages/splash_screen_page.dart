...
import 'package:captain_bonik_app/modules/merchandiser/pages/merchandiser_landing_page.dart';
...
class _SplashScreenState extends State<SplashScreen> with App{
  ...
  void _startPage() {
    Future.delayed(Duration(seconds: 2)).then((x) async{
      Navigator.of(context)..pushAndRemoveUntil(MaterialPageRoute(builder: (context) => MerchandiserUserLandingPage()), ModalRoute.withName('/auth'));
    });
  }
}
